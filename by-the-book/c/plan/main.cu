/*****************************************************************************
    ...
    Both functions `dft` and `fft` accept arrays of float complexs.
    ...
    The `fft_gpu` function accepts arrays of CUDA float complexs.
...
// float complexs using the mathematical definition of the DFT.
...
//
// Parameters:
// x: float complex array that serves as the input
// Y: float complex array in which to store the DFT of x
...
//
// This function computes the discrete Fourier transform (DFT) of a vector of
// float complexs using an iterative version of the Cooley-Tukey fast 
...
//
// This function computes the discrete Fourier transform (DFT) of a vector of
// float complexs using a parallelized iterative version of the Cooley-Tukey fast 
// Fourier transform algorithm (FFT). Computing the output requires 
// O(N log_2 N) operations for input of length N.
//
// Parameters:
// x: CUDA float complex array that serves as the input
// Y: CUDA float complex array in which to store the DFT of x
// N: length of the input and output arrays
//
// N must be a power of 2
//
...
// show_complex_vector
// 
// This function pretty prints an array of float complexs.
//
// Parameters:
// v: an array of float complexs containing at least N elements
...
// 
// Print an array of CUDA float complexs
//
// Parameters:
// v: an array of CUDA float complexs containing at least N elements
// N: print the floats from index 0 to index N-1 
//
// Return value:
// none
...
// Allocate float complexs. Setup using sample data.
...
// Allocate CUDA float complexs. Setup using sample data.
